...
/**
 * Checks whether argument in the [call] is on the same position as it listed in the callable definition.
 *
 ...
 * ```
 */
private fun ValueArgument.placedOnItsOwnPositionInCall(call: ResolvedCall<out CallableDescriptor>): Boolean {
    return call.getParameterForArgument(this)?.index == call.call.valueArguments.indexOf(this)
}
