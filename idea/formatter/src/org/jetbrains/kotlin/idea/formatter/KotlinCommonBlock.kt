...
abstract class KotlinCommonBlock(
        ...
        when {
            elementType === VALUE_ARGUMENT_LIST -> {
                ...
                return getWrappingStrategyForItemList(
                    ...
                    additionalWrap = getTrailingCommaWrappingStrategy(
                        LPAR,
                        RPAR,
                        getThisOrPrevIsMultiLineElement(VALUE_ARGUMENT, COMMA, LPAR, RPAR)
                    )
                )
            }
            ...
            elementType === VALUE_PARAMETER_LIST -> {
                if (parentElementType === FUN ||
                    ...
                    additionalWrap = getTrailingCommaWrappingStrategy(
                        LPAR,
                        RPAR,
                        getThisOrPrevIsMultiLineElement(VALUE_PARAMETER, COMMA, LPAR, RPAR)
                    )
                )
            }
    ...
    private fun getThisOrPrevIsMultiLineElement(
        type: IElementType,
    ...
    private fun getTrailingCommaWrappingStrategy(
